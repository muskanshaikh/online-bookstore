...
function incartupdate(event){
    var shopItems = document.getElementsByClassName('shop-items')[0]

    var button = shopItems.getElementsByClassName('shop-item-button')
    ...
    console.log(button);
       for(i=0;i<button.length;i++){ 
        ...
        button[i].classList.remove('btn-warning');
          ...
          button[i].style.backgroundColor="#56CCF2";
...
function addItemToCart(title, price, imageSrc) {
    ...
    var cartRowContents = `
        ...
        <div class="cart-quantity cart-column">
            ...
            <button class="btn btn-danger" type="button">&#x2716</button>
        </div>`
...
function updateCartTotal() {
    ...
    document.getElementsByClassName('cart-total-price')[0].innerHTML = '<i class="fa fa-inr" aria-hidden="true"></i>' + total
}
